...
//       wedges in a pie cart layout. See the How Does It Work? section below. 
//
...
// 
// How does it work?:
// - Animating a the start and end points does not animate correctly
...
- (void)reloadData
{
    if (_dataSource) {
        ...
        // Calculate the center and radius based on the parent layer's bounds 
        CGRect parentLayerBounds = [parentLayer bounds];
        ...
        if (sliceCount > [pieLayers count]) {
            ...
            // The removed layer does not animate "out". Instead we move the removed layer to the "back" and 
